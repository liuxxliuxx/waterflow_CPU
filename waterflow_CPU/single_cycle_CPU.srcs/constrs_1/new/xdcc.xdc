...
set_switching_activity -default_toggle_rate 2.000
set_switching_activity -toggle_rate 2.000 -static_probability 0.500 [get_nets -hierarchical *]
set_switching_activity -toggle_rate 5.000 -static_probability 0.500 [get_cells -hierarchical -filter {REF_NAME =~ RAMB*}]
reset_switching_activity -all
create_clock -period 10.000 -name my_sys_clk [get_ports clk]
reset_switching_activity -all

set_switching_activity -toggle_rate 2.000 -static_probability 0.500 [get_ports -filter {DIRECTION == IN}]

#set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets clk_IBUF]

set_property IOSTANDARD LVCMOS33 [get_ports clk_lcd]
set_property PACKAGE_PIN AC19 [get_ports clk_lcd]
set_property PACKAGE_PIN Y3 [get_ports clk]
set_property PACKAGE_PIN Y5 [get_ports rst]

set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets u_cpuclk/inst/clk_in1_cpuclk]

...
# sys_clk_i is constrained in constrs_1/new/board_io.xdc at the top level.
# The top level also uses this clock to generate clk_ref_i, so keeping these
# scoped IP pin constraints causes Vivado to warn that they target cell pins.
